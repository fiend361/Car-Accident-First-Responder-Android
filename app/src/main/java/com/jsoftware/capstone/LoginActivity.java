...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button createHospitalAccBtn = findViewById(R.id.create_medical_account_btn);
        createHospitalAccBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, CreateMedicAccountActivity.class));
                //finish();
            }
        });
        ...
        authListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(LoginActivity.this, DrawerActivity2.class));
                    finish();
                }
            }
        };
